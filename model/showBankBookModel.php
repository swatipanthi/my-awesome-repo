...
if(isset($_POST['showDateData']))
{
    ...
    if($date1 and $date2){
        ...
        $sql1 = "SELECT acid, account, transaction_date, amount, operation FROM bank_book WHERE (transaction_date BETWEEN CAST('$date1' AS DATE) AND CAST('$date2' AS DATE)) AND userid=$_SESSION[userid]";
